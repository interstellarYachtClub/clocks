...
const getHours = () => {
  const hours = Date().split(' ')[4].split(':')[0];
  return hours;
}

const getMinutes = () => {
  const minutes = Date().split(' ')[4].split(':')[1];
  return minutes;
}

const getSeconds = () => {
  const seconds = Date().split(' ')[4].split(':')[2];
  return seconds;
}
...
const GetTernaryMinutes = (minutes) => {
...
const GetTernarySeconds = (seconds) => {
